...
; (def grid-str "08 02 22 97 38 15 00 40 00 75 04 05 07 78 52 12 50 77 91 08
...
; (def grid (partition 20 grid-str))
...
; ; Horizontal maximum
; (def hmax (apply max (map (fn [x] (reduce + x)) (partition 20 n-grid))))
